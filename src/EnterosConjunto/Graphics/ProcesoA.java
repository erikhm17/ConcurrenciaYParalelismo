        ...
        * lista */
        try {
            for (MyMap s : S) {
                ...
                if ((data = buzonSincrono.take()).getClave() != MainConsole.infinito) {
                    ...
                    System.out.println("Escribiendo el arreglo S ");
                    for (MyMap s1 : S) {
            ...
            buzonSincrono.put(new MyMap(MainConsole.infinito, MainConsole.infinito));
